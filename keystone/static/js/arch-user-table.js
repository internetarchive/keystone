import{i as e,_ as t,e as r,y as s,a}from"./chunk-lit-element.js";import{t as i}from"./chunk-state.js";import{U as o}from"./chunk-helpers.js";import{i as l,t as n}from"./chunk-helpers2.js";import{T as d}from"./chunk-pubsub.js";import{A as m}from"./chunk-arch-data-table.js";import{B as h,i as c}from"./chunk-styles.js";import{A as u}from"./chunk-ArchAPI.js";import{ArchEditUserModal as p}from"./arch-edit-user-modal.js";import{A as b}from"./chunk-arch-modal.js";import"./chunk-arch-loading-indicator.js";import"./arch-hover-tooltip.js";import"./chunk-scale-large.js";import"./chunk-sp-overlay.js";import"./chunk-arch-select-adder.js";import"./chunk-sizedMixin.js";var f=[...b.styles,h,e`
  ...
  `];let y=class extends b{constructor(){super(),this.accountTeams=[],u.teams.list().then((e=>{this.accountTeams=e.items,this.renderContent()}))}set unhandledError(e){const{errorEl:t}=this;e?t.classList.add("show"):t.classList.remove("show")}connectedCallback(){super.connectedCallback(),this.scrollable=!0,this.modalSize="m",this.title="Create a New User",this.submitButtonText="Create",this.renderContent(),this.addEventListener("sp-closed",this.onCloseHandler.bind(this))}renderContent(){this.content=s`
    ...
    `}submit(){const{form:e,teamsSelector:t}=this;if(!e.checkValidity())return void e.reportValidity();const r=new FormData(this.form),s={account_id:parseInt(r.get("account-id")),email:r.get("user-email"),first_name:r.get("first-name"),last_name:r.get("last-name"),role:r.get("user-role"),username:r.get("user-name"),teams:t.selectedOptions.map((e=>({id:e.id,name:e.name})))};this.createUser(s,r.has("send-email"))}clearErrors(){this.unhandledError=!1,this.form&&(this.usernameInput.setCustomValidity(""),this.emailInput.setCustomValidity(""))}clearInputValidityOnChange(e){const t=()=>{e.setCustomValidity(""),e.removeEventListener("input",t)};e.addEventListener("input",t)}createUser(e,t){this.clearErrors(),u.users.create(e,t).then((()=>{this.open=!1,this.onCreate()})).catch((e=>{var t;400!==(null===(t=e.response)||void 0===t?void 0:t.status)?this.unhandledError=!0:e.response.json().then((e=>{const{details:t}=e;let r=!0;t.endsWith("already exists for field (username)")&&(this.usernameInput.setCustomValidity("A user with this Username already exists."),this.usernameInput.reportValidity(),this.clearInputValidityOnChange(this.usernameInput),r=!1),t.endsWith("already exists for field (email)")&&(this.emailInput.setCustomValidity("A user with this Email already exists."),this.emailInput.reportValidity(),this.clearInputValidityOnChange(this.emailInput),r=!1),this.unhandledError=r})).catch((()=>{this.unhandledError=!0}))}))}onCloseHandler(){var e;null===(e=this.form)||void 0===e||e.reset(),this.teamsSelector.reset(),this.clearErrors()}};y.styles=f,t([r({type:Number})],y.prototype,"accountId",void 0),t([r()],y.prototype,"onCreate",void 0),t([c("form")],y.prototype,"form",void 0),t([c("form > input#user-name")],y.prototype,"usernameInput",void 0),t([c("form > input#user-email")],y.prototype,"emailInput",void 0),t([c("div.error")],y.prototype,"errorEl",void 0),t([c("arch-user-teams-selector")],y.prototype,"teamsSelector",void 0),t([i()],y.prototype,"accountTeams",void 0),y=t([a("arch-create-new-user-modal")],y);var g=[e`
    data-table > table {
      table-layout: fixed;
    }
