...
`;const f=r`#2991cc`,g=r`#fff`;r`#dce0e0`,r`#dce0e0`;const $=r`#052c65`,m=r`#2b2f32`,p=r`#0a3622`,h=r`#055160`,k=r`#664d03`,v=r`#58151c`,y=r`#495057`,w=r`#495057`,x=r`#f8d7da`,z=r`
  :host {
    color: #222;
...
`;export{q as B,u as G,f as a,g as b,C as c,n as d,z as g,t as i};
