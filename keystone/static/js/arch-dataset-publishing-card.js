      ...
      <div class="container">
        <div class="detail">
          <dl>
            ...
            ${t!==_.Published?s``:s`
                  <div>
                    <dt>ARK</dt>
                    <dd>
                      <a href="https://ark.archive.org/${a.ark}"
                        >${a.ark}</a
                      >
                    </dd>
                  </div>
          ...
          <h2>
            ...
            ${t<_.Published||this.metadataState===w.Editing||e?"":s`
                  <button
                    class="text"
          ...
          >
            ${void 0===i?s`<arch-loading-indicator></arch-loading-indicator>`:0===Object.keys(i).length?s`<i>none</i>`:s`
                  <dl>
                    ${I.filter((t=>void 0!==i[t])).map((t=>{const e=function(t){return $.properties[t].title}(t);let a=i[t];return Array.isArray(a)||(a=[a]),s`
                          <div>
                            <dt>${e}</dt>
                            ${a.map((t=>s`<dd>${t}</dd>`))}
                          </div>
        ...
        <button
          class="${t===_.Unpublished?"primary":t===_.PrePublish?"success":t===_.Published?"danger":""} ${e?"hidden":""}"
