import{b as r,c as e,i as t}from"./chunk-query-assigned-elements.js";import"./chunk-define-element.js";
/**
 * @license
 * Copyright 2018 Google LLC
 * SPDX-License-Identifier: BSD-3-Clause
 */const a=e=>null!=e?e:r,o=["spectrum","express"],s=["medium","large","medium-express","large-express"],c=["light","lightest","dark","darkest","light-express","lightest-express","dark-express","darkest-express"],l=class r extends HTMLElement{constructor(){super(),this._dir="",this._theme="spectrum",this._color="",this._scale="",this.trackedChildren=new Set,this._updateRequested=!1,this._contextConsumers=new Map,this.attachShadow({mode:"open"});const e=document.importNode(r.template.content,!0);this.shadowRoot.appendChild(e),this.shouldAdoptStyles(),this.addEventListener("sp-query-theme",this.onQueryTheme),this.addEventListener("sp-language-context",this._handleContextPresence),this.updateComplete=this.__createDeferredPromise()}static get observedAttributes(){return["color","scale","theme","lang","dir"]}set dir(r){if(r===this.dir)return;this.setAttribute("dir",r),this._dir=r;const e="rtl"===r?r:"ltr";this.trackedChildren.forEach((r=>{r.setAttribute("dir",e)}))}get dir(){return this._dir}attributeChangedCallback(r,e,t){e!==t&&("color"===r?this.color=t:"scale"===r?this.scale=t:"lang"===r&&t?(this.lang=t,this._provideContext()):"theme"===r?this.theme=t:"dir"===r&&(this.dir=t))}requestUpdate(){void 0===window.ShadyCSS||window.ShadyCSS.nativeShadow?this.shouldAdoptStyles():window.ShadyCSS.styleElement(this)}get theme(){const e=r.themeFragmentsByKind.get("theme"),{name:t}=e&&e.get("default")||{};return this._theme||t||""}set theme(r){if(r===this._theme)return;const e=r&&o.includes(r)?r:this.theme;e!==this._theme&&(this._theme=e,this.requestUpdate()),e?this.setAttribute("theme",e):this.removeAttribute("theme")}get color(){const e=r.themeFragmentsByKind.get("color"),{name:t}=e&&e.get("default")||{};return this._color||t||""}set color(r){if(r===this._color)return;const e=r&&c.includes(r)?r:this.color;e!==this._color&&(this._color=e,this.requestUpdate()),e?this.setAttribute("color",e):this.removeAttribute("color")}get scale(){const e=r.themeFragmentsByKind.get("scale"),{name:t}=e&&e.get("default")||{};return this._scale||t||""}set scale(r){if(r===this._scale)return;const e=r&&s.includes(r)?r:this.scale;e!==this._scale&&(this._scale=e,this.requestUpdate()),e?this.setAttribute("scale",e):this.removeAttribute("scale")}get styles(){const e=[...r.themeFragmentsByKind.keys()],t=(r,e,t)=>{const a=t&&"theme"!==t&&"express"===this.theme?r.get(`${e}-express`):r.get(e),o="spectrum"===e||!t||this.hasAttribute(t);if(a&&o)return a.styles};return[...e.reduce(((e,a)=>{const o=r.themeFragmentsByKind.get(a);let s;if("app"===a||"core"===a)s=t(o,a);else{const{[a]:r}=this;s=t(o,r,a)}return s&&e.push(s),e}),[])]}static get template(){return this.templateElement||(this.templateElement=document.createElement("template"),this.templateElement.innerHTML="<slot></slot>"),this.templateElement}__createDeferredPromise(){return new Promise((r=>{this.__resolve=r}))}onQueryTheme(r){if(r.defaultPrevented)return;r.preventDefault();const{detail:e}=r;e.color=this.color||void 0,e.scale=this.scale||void 0,e.lang=this.lang||document.documentElement.lang||navigator.language,e.theme=this.theme||void 0}connectedCallback(){if(this.shouldAdoptStyles(),void 0!==window.ShadyCSS&&window.ShadyCSS.styleElement(this),r.instances.add(this),!this.hasAttribute("dir")){let e=this.assignedSlot||this.parentNode;for(;e!==document.documentElement&&!(e instanceof r);)e=e.assignedSlot||e.parentNode||e.host;this.dir="rtl"===e.dir?e.dir:"ltr"}}disconnectedCallback(){r.instances.delete(this)}startManagingContentDirection(r){this.trackedChildren.add(r)}stopManagingContentDirection(r){this.trackedChildren.delete(r)}async shouldAdoptStyles(){this._updateRequested||(this.updateComplete=this.__createDeferredPromise(),this._updateRequested=!0,this._updateRequested=await!1,this.adoptStyles(),this.__resolve(!0))}adoptStyles(){const t=this.styles;if(void 0!==window.ShadyCSS&&!window.ShadyCSS.nativeShadow&&window.ShadyCSS.ScopingShim){const e=[];for(const[t,a]of r.themeFragmentsByKind)for(const[o,{styles:s}]of a){if("default"===o)continue;let a=s.cssText;r.defaultFragments.has(o)||(a=a.replace(":host",`:host([${t}='${o}'])`)),e.push(a)}window.ShadyCSS.ScopingShim.prepareAdoptedCssText(e,this.localName),window.ShadyCSS.prepareTemplate(r.template,this.localName)}else if(e){const r=[];for(const e of t)r.push(e.styleSheet);this.shadowRoot.adoptedStyleSheets=r}else this.shadowRoot.querySelectorAll("style").forEach((r=>r.remove())),t.forEach((r=>{const e=document.createElement("style");e.textContent=r.cssText,this.shadowRoot.appendChild(e)}))}static registerThemeFragment(e,t,a){const o=r.themeFragmentsByKind.get(t)||new Map;0===o.size&&(r.themeFragmentsByKind.set(t,o),o.set("default",{name:e,styles:a}),r.defaultFragments.add(e)),o.set(e,{name:e,styles:a}),r.instances.forEach((r=>r.shouldAdoptStyles()))}_provideContext(){this._contextConsumers.forEach((([r,e])=>r(this.lang,e)))}_handleContextPresence(r){r.stopPropagation();const e=r.composedPath()[0];if(this._contextConsumers.has(e))return;this._contextConsumers.set(e,[r.detail.callback,()=>this._contextConsumers.delete(e)]);const[t,a]=this._contextConsumers.get(e)||[];t&&a&&t(this.lang||document.documentElement.lang||navigator.language,a)}};l.themeFragmentsByKind=new Map,l.defaultFragments=new Set(["spectrum"]),l.instances=new Set;let m=l;customElements.define("sp-theme",m);const u=t`
...
`;m.registerThemeFragment("spectrum","theme",p),m.registerThemeFragment("light","color",u);const i=t`
...
`;m.registerThemeFragment("lightest","color",i);const n=t`
...
`;m.registerThemeFragment("dark","color",n);const g=t`
...
`;m.registerThemeFragment("darkest","color",g);const b=t`
...
`;m.registerThemeFragment("medium","scale",b);const d=t`
...
`;m.registerThemeFragment("large","scale",d);export{a as l};
//# sourceMappingURL=chunk-scale-large.js.map
