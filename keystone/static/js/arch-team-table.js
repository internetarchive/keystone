import{i as e,_ as t,e as r,y as a,a as s}from"./chunk-lit-element.js";import{t as o}from"./chunk-state.js";import{U as i}from"./chunk-helpers.js";import{t as n}from"./chunk-helpers2.js";import{T as l}from"./chunk-pubsub.js";import{A as d}from"./chunk-arch-data-table.js";import{B as m,i as c,g as h}from"./chunk-styles.js";import{A as p}from"./chunk-ArchAPI.js";import{A as u}from"./chunk-arch-modal.js";import{A as b}from"./chunk-arch-select-adder.js";import"./chunk-domLib.js";import"./arch-loading-indicator.js";import"./arch-hover-tooltip.js";import"./chunk-scale-large.js";import"./chunk-sp-overlay.js";import"./chunk-sizedMixin.js";var f=[...u.styles,m,e`
  ...
  `];let y=class extends u{set unhandledError(e){const{errorEl:t}=this;e?t.classList.add("show"):t.classList.remove("show")}connectedCallback(){super.connectedCallback(),this.scrollable=!0,this.modalSize="m",this.title="Create a New Team",this.submitButtonText="Create",this.content=a`
    ...
    `,this.addEventListener("sp-closed",this.onCloseHandler.bind(this))}submit(e){e&&(e.preventDefault(),e.stopPropagation());const{form:t}=this;if(!t.checkValidity())return void t.reportValidity();const r=new FormData(this.form),a={account_id:parseInt(r.get("account-id")),name:r.get("name")};this.createTeam(a)}clearErrors(){this.unhandledError=!1,this.form&&this.nameInput.setCustomValidity("")}clearInputValidityOnChange(e){const t=()=>{e.setCustomValidity(""),e.removeEventListener("input",t)};e.addEventListener("input",t)}createTeam(e){this.clearErrors(),p.teams.create(e).then((()=>{this.open=!1,this.onCreate()})).catch((e=>{var t;400!==(null===(t=e.response)||void 0===t?void 0:t.status)?this.unhandledError=!0:e.response.json().then((e=>{const{details:t}=e;let r=!0;t.endsWith("already exists for fields ('lower(name::text)', 'account_id')")&&(this.nameInput.setCustomValidity("A team with this name already exists."),this.nameInput.reportValidity(),this.clearInputValidityOnChange(this.nameInput),r=!1),this.unhandledError=r})).catch((()=>{this.unhandledError=!0}))}))}onCloseHandler(){var e;null===(e=this.form)||void 0===e||e.reset(),this.clearErrors()}};y.styles=f,t([r({type:Number})],y.prototype,"accountId",void 0),t([r()],y.prototype,"onCreate",void 0),t([c("form")],y.prototype,"form",void 0),t([c("form > input#name")],y.prototype,"nameInput",void 0),t([c("div.error")],y.prototype,"errorEl",void 0),y=t([s("arch-create-new-team-modal")],y);var g=[h,e`
    h3 {
  ...
  `];let v=class extends b{connectedCallback(){this.reset(),this.deselectButtonText="remove",this.headingLevel=0,this.selectCtaText="Add a user",this.valueGetter=e=>String(e.id),this.labelGetter=e=>e.username,super.connectedCallback()}willUpdate(e){e.has("teamMembers")&&this.reset()}reset(){const{accountUsers:e,teamMembers:t}=this;this.options=e.slice(),this.selectedOptions=t.slice()}};v.styles=g,t([r({type:Array})],v.prototype,"accountUsers",void 0),t([r({type:Array})],v.prototype,"teamMembers",void 0),v=t([s("arch-team-members-selector")],v);var T=[...u.styles,m,e`
    form > label {
      font-weight: normal;
      margin-top: 0.5rem;
      font-size: 0.95rem;
  ...
  `];let w=class extends u{constructor(){super(),this.onUpdate=e=>null,this.accountUsers=[],p.users.list().then((e=>this.accountUsers=e.items))}set unhandledError(e){const{errorEl:t}=this;e?t.classList.add("show"):t.classList.remove("show")}set team(e){const{accountUsers:t}=this;this.content=void 0!==e?a`
      <form @submit=${this.submit} validate>
    ...
    `:a``}connectedCallback(){super.connectedCallback(),this.scrollable=!0,this.modalSize="m",this.submitButtonText="Save",this.title="Edit Team",this.addEventListener("sp-closed",this.onCloseHandler.bind(this))}submit(e){e&&(e.preventDefault(),e.stopPropagation());const{form:t,membersSelector:r}=this;if(!t.checkValidity())return void t.reportValidity();const a=new FormData(this.form),s=parseInt(a.get("id")),o={name:a.get("name"),members:r.selectedOptions};this.updateTeam(s,o)}clearErrors(){this.unhandledError=!1,this.form&&this.nameInput.setCustomValidity("")}clearInputValidityOnChange(e){const t=()=>{e.setCustomValidity(""),e.removeEventListener("input",t)};e.addEventListener("input",t)}updateTeam(e,t){this.clearErrors(),p.teams.update(e,t).then((e=>{this.open=!1;try{this.onUpdate(e)}catch(e){console.error(e)}})).catch((e=>{var t;400!==(null===(t=e.response)||void 0===t?void 0:t.status)?this.unhandledError=!0:e.response.json().then((e=>{const{details:t}=e;t.endsWith("already exists for fields ('lower(name::text)', 'account_id')")?(this.nameInput.setCustomValidity("A team with this name already exists."),this.nameInput.reportValidity(),this.clearInputValidityOnChange(this.nameInput)):this.unhandledError=!0})).catch((()=>this.unhandledError=!0))}))}onCloseHandler(){var e;null===(e=this.form)||void 0===e||e.reset(),this.membersSelector.reset(),this.clearErrors()}};w.styles=T,t([r()],w.prototype,"onUpdate",void 0),t([c("form")],w.prototype,"form",void 0),t([c("form > input#name")],w.prototype,"nameInput",void 0),t([c("div.error")],w.prototype,"errorEl",void 0),t([c("arch-team-members-selector")],w.prototype,"membersSelector",void 0),t([o()],w.prototype,"accountUsers",void 0),w=t([s("arch-edit-team-modal")],w);var E=[e`
    data-table > table {
      table-layout: fixed;
    }
