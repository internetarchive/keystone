import{i as t,b as o,e as i,_ as e,s as p,y as r,a}from"./chunk-query-assigned-elements.js";import{S as l,f as n,x as s,d as c}from"./chunk-scale-large.js";import{i as m,g as u}from"./chunk-styles.js";import"./chunk-state.js";const g=t`
 ...
 */;var d=Object.defineProperty,h=Object.getOwnPropertyDescriptor,v=(t,o,i,e)=>{for(var p,r=e>1?void 0:e?h(o,i):o,a=t.length-1;a>=0;a--)(p=t[a])&&(r=(e?p(o,i,r):p(r))||r);return e&&r&&d(o,i,r),r};class b extends HTMLElement{constructor(){super(),this._open=!1,this._placement="top",this.addEventListener("sp-opened",this.redispatchEvent),this.addEventListener("sp-closed",this.redispatchEvent)}redispatchEvent(t){t.stopPropagation(),this.tooltip.dispatchEvent(new CustomEvent(t.type,{bubbles:t.bubbles,composed:t.composed,detail:t.detail}))}get tooltip(){return this.getRootNode().host}static get observedAttributes(){return["open","placement"]}attributeChangedCallback(t,o,i){switch(t){case"open":this.open=null!==i;break;case"placement":this.placement=i}}set open(t){this._open=t;const{tooltip:o}=this;o&&(o.open=t)}get open(){return this._open}set placement(t){this._placement=t;const{tooltip:o}=this;o&&(o.placement=t)}get placement(){return this._placement}get tipElement(){return this.tooltip.tipElement}}customElements.get("sp-tooltip-openable")||customElements.define("sp-tooltip-openable",b);class f extends l{constructor(){super(...arguments),this.selfManaged=!1,this.offset=0,this.open=!1,this._variant="",this.handleOpenOverlay=()=>{this.open=!0},this.handleCloseOverlay=()=>{this.open=!1}}static get styles(){return[g]}get variant(){return this._variant}set variant(t){if(t!==this.variant){if(["info","positive","negative"].includes(t))return this.setAttribute("variant",t),void(this._variant=t);this.removeAttribute("variant"),this._variant=""}}forwardTransitionEvent(t){this.dispatchEvent(new TransitionEvent(t.type,{bubbles:!0,composed:!0,propertyName:t.propertyName}))}get triggerElement(){var t;let o=this.assignedSlot||this,i=o.getRootNode(),e=o.parentElement||i.host||i;for(;null==(t=null==e?void 0:e.matches)||!t.call(e,n);)o=e.assignedSlot||e,i=o.getRootNode(),e=o.parentElement||i.host||i;return e}render(){const t=s`
            <sp-tooltip-openable
                id="tooltip"
        ...
        `;return this.selfManaged?(import("./chunk-scale-large.js").then((function(t){return t.s})),s`
                <sp-overlay
                    ?open=${this.open}
                    offset=${this.offset}
            ...
            `):t}connectedCallback(){super.connectedCallback(),this.updateComplete.then((()=>{if(!this.selfManaged)return;const t=this.overlayElement;if(t){const o=this.triggerElement;t.triggerElement=o}}))}}v([i({type:Boolean,attribute:"self-managed"})],f.prototype,"selfManaged",2),v([i({type:Number})],f.prototype,"offset",2),v([i({type:Boolean,reflect:!0})],f.prototype,"open",2),v([m("sp-overlay")],f.prototype,"overlayElement",2),v([i({reflect:!0})],f.prototype,"placement",2),v([m("#tip")],f.prototype,"tipElement",2),v([i({type:Number})],f.prototype,"tipPadding",2),v([i({type:String})],f.prototype,"variant",1),c("sp-tooltip",f);var T=[u,t``];let k=class extends p{constructor(){super(...arguments),this.text=""}render(){const{text:t}=this;return r`
    ...
    `}connectedCallback(){super.connectedCallback(),this.trySetupClickListener()}trySetupClickListener(){var t,o,i;const e=null===(i=null===(o=null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector("overlay-trigger"))||void 0===o?void 0:o.shadowRoot)||void 0===i?void 0:i.querySelector("#trigger");e?e.addEventListener("click",(()=>{var t;null===(t=this.parentElement)||void 0===t||t.click()}),!0):setTimeout(this.trySetupClickListener.bind(this),100)}};k.styles=T,e([i({type:String})],k.prototype,"text",void 0),k=e([a("arch-hover-tooltip")],k);export{k as ArchHoverTooltip};
