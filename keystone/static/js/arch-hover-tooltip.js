import{i as t,e as o,y as i,_ as e,s as p,a as r}from"./chunk-query-assigned-elements.js";import{f as a}from"./chunk-sp-overlay.js";import{l}from"./chunk-scale-large.js";import{S as n,d as s}from"./chunk-define-element.js";import{i as c,g as m}from"./chunk-styles.js";import"./chunk-state.js";import"./chunk-directive.js";const u=t`
...
`;var d=Object.defineProperty,g=Object.getOwnPropertyDescriptor,h=(t,o,i,e)=>{for(var p,r=e>1?void 0:e?g(o,i):o,a=t.length-1;a>=0;a--)(p=t[a])&&(r=(e?p(o,i,r):p(r))||r);return e&&r&&d(o,i,r),r};class v extends HTMLElement{constructor(){super(),this._open=!1,this._placement="top",this.addEventListener("sp-opened",this.redispatchEvent),this.addEventListener("sp-closed",this.redispatchEvent)}redispatchEvent(t){t.stopPropagation(),this.tooltip.dispatchEvent(new CustomEvent(t.type,{bubbles:t.bubbles,composed:t.composed,detail:t.detail}))}get tooltip(){return this.getRootNode().host}static get observedAttributes(){return["open","placement"]}attributeChangedCallback(t,o,i){switch(t){case"open":this.open=null!==i;break;case"placement":this.placement=i}}set open(t){this._open=t;const{tooltip:o}=this;o&&(o.open=t)}get open(){return this._open}set placement(t){this._placement=t;const{tooltip:o}=this;o&&(o.placement=t)}get placement(){return this._placement}get tipElement(){return this.tooltip.tipElement}}customElements.get("sp-tooltip-openable")||customElements.define("sp-tooltip-openable",v);class b extends n{constructor(){super(...arguments),this.selfManaged=!1,this.offset=0,this.open=!1,this._variant="",this.handleOpenOverlay=()=>{this.open=!0},this.handleCloseOverlay=()=>{this.open=!1}}static get styles(){return[u]}get variant(){return this._variant}set variant(t){if(t!==this.variant){if(["info","positive","negative"].includes(t))return this.setAttribute("variant",t),void(this._variant=t);this.removeAttribute("variant"),this._variant=""}}forwardTransitionEvent(t){this.dispatchEvent(new TransitionEvent(t.type,{bubbles:!0,composed:!0,propertyName:t.propertyName}))}get triggerElement(){var t;let o=this.assignedSlot||this,i=o.getRootNode(),e=o.parentElement||i.host||i;for(;null==(t=null==e?void 0:e.matches)||!t.call(e,a);)o=e.assignedSlot||e,i=o.getRootNode(),e=o.parentElement||i.host||i;return e}render(){const t=i`
            <sp-tooltip-openable
                id="tooltip"
        ...
        `;return this.selfManaged?(import("./chunk-sp-overlay.js").then((function(t){return t.s})),i`
                <sp-overlay
                    ?open=${this.open}
                    offset=${this.offset}
            ...
            `):t}connectedCallback(){super.connectedCallback(),this.updateComplete.then((()=>{if(!this.selfManaged)return;const t=this.overlayElement;if(t){const o=this.triggerElement;t.triggerElement=o}}))}}h([o({type:Boolean,attribute:"self-managed"})],b.prototype,"selfManaged",2),h([o({type:Number})],b.prototype,"offset",2),h([o({type:Boolean,reflect:!0})],b.prototype,"open",2),h([c("sp-overlay")],b.prototype,"overlayElement",2),h([o({reflect:!0})],b.prototype,"placement",2),h([c("#tip")],b.prototype,"tipElement",2),h([o({type:Number})],b.prototype,"tipPadding",2),h([o({type:String})],b.prototype,"variant",1),s("sp-tooltip",b);var f=[m,t``];let T=class extends p{constructor(){super(...arguments),this.text=""}render(){const{text:t}=this;return i`
    ...
    `}connectedCallback(){super.connectedCallback(),this.trySetupClickListener()}trySetupClickListener(){var t,o,i;const e=null===(i=null===(o=null===(t=this.shadowRoot)||void 0===t?void 0:t.querySelector("overlay-trigger"))||void 0===o?void 0:o.shadowRoot)||void 0===i?void 0:i.querySelector("#trigger");e?e.addEventListener("click",(()=>{var t;null===(t=this.parentElement)||void 0===t||t.click()}),!0):setTimeout(this.trySetupClickListener.bind(this),100)}};T.styles=f,e([o({type:String})],T.prototype,"text",void 0),T=e([r("arch-hover-tooltip")],T);export{T as ArchHoverTooltip};
//# sourceMappingURL=arch-hover-tooltip.js.map
