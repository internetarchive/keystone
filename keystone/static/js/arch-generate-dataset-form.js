...
`;var O=Object.defineProperty,J=Object.getOwnPropertyDescriptor,q=(t,e,o,s)=>{for(var a,i=s>1?void 0:s?J(e,o):e,r=t.length-1;r>=0;r--)(a=t[r])&&(i=(s?a(e,o,i):a(i))||i);return s&&i&&O(e,o,i),i};const B={baseSize:100,noSelectionStyle:"transform: translateX(0px) scaleX(0) scaleY(0)",transformX(t,e){return`transform: translateX(${t}px) scaleX(${e/this.baseSize});`},transformY(t,e){return`transform: translateY(${t}px) scaleY(${e/this.baseSize});`},baseStyles(){return t`
...
`;var W=Object.defineProperty,G=Object.getOwnPropertyDescriptor,Y=(t,e,o,s)=>{for(var a,i=s>1?void 0:s?G(e,o):e,r=t.length-1;r>=0;r--)(a=t[r])&&(i=(s?a(e,o,i):a(i))||i);return s&&i&&W(e,o,i),i};const X=class t extends(m(C(z(u,'[slot="icon"]'),""))){constructor(){super(...arguments),this.disabled=!1,this.label="",this.selected=!1,this.vertical=!1,this.value=""}static get styles(){return[R]}get hasIcon(){return this.slotContentIsPresent}get hasLabel(){return!!this.label||this.slotHasContent}render(){return e`
            ${this.hasIcon?e`
                      <slot name="icon"></slot>
                  `:s}
...
`;var Q=Object.defineProperty,V=Object.getOwnPropertyDescriptor,Z=(t,e,o,s)=>{for(var a,i=s>1?void 0:s?V(e,o):e,r=t.length-1;r>=0;r--)(a=t[r])&&(i=(s?a(e,o,i):a(i))||i);return s&&i&&Q(e,o,i),i};const tt=class t extends u{constructor(){super(...arguments),this.selected=!1,this.value=""}handleFocusin(){this.removeAttribute("tabindex")}handleFocusout(){this.tabIndex=this.selected?0:-1}render(){return e`
            <slot
  ...
  `];let ot=class extends x{};ot.styles=et,ot=a([i("arch-job-parameters-form")],ot);var st=[b,g,t`
    div > h3 {
      margin-top: 0;
    }
  ...
  `];let at=class extends r{constructor(){super(...arguments),this.buttonClass="",this.buttonHTML=e``,this.jobName="",this.collectionName="",this.jobStateTuples=[]}renderButton(){const{jobStateTuples:t}=this,o=(t,o,s)=>e`
    ...
    `}};var it;at.styles=st,at.shadowRootOptions={...r.shadowRootOptions,delegatesFocus:!0},a([o()],at.prototype,"buttonClass",void 0),a([o()],at.prototype,"buttonHTML",void 0),a([o()],at.prototype,"jobName",void 0),a([o()],at.prototype,"collectionName",void 0),a([o()],at.prototype,"jobStateTuples",void 0),at=a([i("arch-job-button")],at);let rt=it=class extends r{constructor(){super(...arguments),this.jobParameters={}}extendParamsSchemaWithDefaultOptions(t){return t=null!=t?t:it.DefaultParametersSchema,Object.assign(t,{properties:Object.assign(t.properties,{sample:{type:"boolean",title:"Sample",default:!0,description:"Generate a sample dataset from a small subset of records"}})})}get historicalDatasetsUrl(){const{collectionId:t,job:e}=this;return`${$.collection(t)}?column-name=${encodeURIComponent(e.name)}`}renderHistory(){const{jobIdStatesMap:t,job:o}=this,s=t&&t[o.id];if(void 0===s||0===s.length)return e`
      ...
      <p class="history">
        ...
        <a href="${$.dataset(a[0][0])}">
          <strong>${N(a[0][1])}</strong> </a
        >.
      </p>
    `}renderConfigureJob(){const{job:t}=this;return e`
      ...
      ></arch-job-parameters-form>
    `}emitGenerateDataset(t){t.stopPropagation(),this.dispatchEvent(new CustomEvent("generate-dataset",{detail:{archJobCard:this},bubbles:!0,composed:!0}))}render(){var t;const{collectionId:o,collectionName:s,job:a,jobIdStatesMap:i}=this,{id:r}=a,n=this.jobIdStatesMap?null!==(t=i[r])&&void 0!==t?t:null:void 0;return e` <div>
      <h3>${a.name}</h3>
      <p>${a.description}</p>
      ${null===o?e`<p class="alert alert-info">
          ...
          `}
    </div>`}};rt.styles=st,rt.DefaultParametersSchema={type:"object",required:[],properties:{}},a([o({type:Number})],rt.prototype,"collectionId",void 0),a([o({type:String})],rt.prototype,"collectionName",void 0),a([o()],rt.prototype,"job",void 0),a([o()],rt.prototype,"jobIdStatesMap",void 0),a([n()],rt.prototype,"jobParameters",void 0),a([h("arch-job-button")],rt.prototype,"jobButton",void 0),rt=it=a([i("arch-job-card")],rt);var nt=[b,t`
    label {
      background-color: ${p};
      color: ${v};
      padding: 0.5rem;
  ...
  `];let ct=class extends r{render(){const{collectionId:t,collectionName:o,jobIdStatesMap:s}=this,{categoryDescription:a,categoryId:i,categoryImage:r,categoryName:n,jobs:c}=this.jobsCat;return e`
      <div class="category-header">
        <img
          ...
          alt="Icon for ${n}"
        />
        <h2 id="${i}" class="category-title">${n}</h2>
