...
`;var U=Object.defineProperty,J=Object.getOwnPropertyDescriptor,q=(t,e,o,s)=>{for(var a,i=s>1?void 0:s?J(e,o):e,r=t.length-1;r>=0;r--)(a=t[r])&&(i=(s?a(e,o,i):a(i))||i);return s&&i&&U(e,o,i),i};const B={baseSize:100,noSelectionStyle:"transform: translateX(0px) scaleX(0) scaleY(0)",transformX(t,e){return`transform: translateX(${t}px) scaleX(${e/this.baseSize});`},transformY(t,e){return`transform: translateY(${t}px) scaleY(${e/this.baseSize});`},baseStyles(){return t`
...
`;var W=Object.defineProperty,Y=Object.getOwnPropertyDescriptor,G=(t,e,o,s)=>{for(var a,i=s>1?void 0:s?Y(e,o):e,r=t.length-1;r>=0;r--)(a=t[r])&&(i=(s?a(e,o,i):a(i))||i);return s&&i&&W(e,o,i),i};const K=class t extends(m(w(k(b,'[slot="icon"]'),""))){constructor(){super(...arguments),this.disabled=!1,this.label="",this.selected=!1,this.vertical=!1,this.value=""}static get styles(){return[R]}get hasIcon(){return this.slotContentIsPresent}get hasLabel(){return!!this.label||this.slotHasContent}render(){return e`
            ${this.hasIcon?e`
                      <slot name="icon"></slot>
                  `:s}
...
`;var Q=Object.defineProperty,V=Object.getOwnPropertyDescriptor,Z=(t,e,o,s)=>{for(var a,i=s>1?void 0:s?V(e,o):e,r=t.length-1;r>=0;r--)(a=t[r])&&(i=(s?a(e,o,i):a(i))||i);return s&&i&&Q(e,o,i),i};const tt=class t extends b{constructor(){super(...arguments),this.selected=!1,this.value=""}handleFocusin(){this.removeAttribute("tabindex")}handleFocusout(){this.tabIndex=this.selected?0:-1}render(){return e`
            ...
            ></slot>
        `}firstUpdated(){this.slot="tab-panel",this.setAttribute("role","tabpanel"),this.tabIndex=0,this.hasAttribute("id")||(this.id="sp-tab-panel-"+t.instanceCount++)}updated(t){t.has("selected")&&(this.selected?(this.removeAttribute("aria-hidden"),this.tabIndex=0):(this.setAttribute("aria-hidden","true"),this.tabIndex=-1))}};tt.styles=[X],tt.instanceCount=0,Z([o({type:Boolean,reflect:!0})],tt.prototype,"selected",2),Z([o({type:String,reflect:!0})],tt.prototype,"value",2),c("sp-tab-panel",tt);var et=[u,...v,t`
    div.input-block {
  ...
  `];let ot=class extends g{};ot.styles=et,ot=a([i("arch-job-parameters-form")],ot);var st=[u,p,t`
    dl {
  ...
  `];let at=class extends r{constructor(){super(...arguments),this.buttonClass="",this.buttonHTML=e``,this.jobName="",this.collectionName="",this.jobStateTuples=[]}renderButton(){const{jobStateTuples:t}=this,o=(t,o,s,a="")=>e`
      <button slot="trigger" class=${a} ?disabled=${s}>
        ${o?e`<arch-loading-indicator
              text=${t}
            ></arch-loading-indicator>`:t}
      </button>
    `;switch(t){case void 0:return o("Loading",!0,!0);case null:return o("Generate Dataset",!1,!1,"primary")}switch(t[0][2]){case C.SUBMITTED:return o("Job Starting",!0,!0);case C.QUEUED:return o("Job Queued",!1,!0);case C.RUNNING:return o("Job Running",!0,!0);case C.FINISHED:case C.FAILED:case C.CANCELLED:return o("Generate New Dataset",!1,!1,"primary")}}render(){const{jobParameters:t,jobName:o,collectionName:s}=this;return e`
  ...
  `];let ct=class extends r{render(){const{collectionId:t,collectionName:o,jobIdStatesMap:s}=this,{categoryDescription:a,jobs:i}=this.jobsCat;return e`
    ...
    `}};ct.styles=nt,a([o({type:String})],ct.prototype,"collectionId",void 0),a([o({type:String})],ct.prototype,"collectionName",void 0),a([o({type:Object})],ct.prototype,"jobsCat",void 0),a([o({type:Object})],ct.prototype,"jobIdStatesMap",void 0),ct=a([i("arch-job-category-section")],ct);const lt=["Collection","Network","Text","File Formats"],dt={Collection:["Domain frequency","Web archive transformation (WAT)"],Network:["Domain graph","Image graph","Longitudinal graph","Web graph"],Text:["Named entities","Plain text of webpages","Text file information"],"File Formats":["Audio file information","Image file information","PDF file information","Presentation file information","Spreadsheet file information","Video file information","Word processing file information"]};let ht=class extends r{constructor(){super(...arguments),this.collections=null,this.collectionIdNameMap=new Map,this.availableJobs=[],this.sourceCollectionId=null,this.collectionJobIdStatesMapMap={},this.activePollCollectionId=null}async connectedCallback(){await this.initAvailableJobs(),this.initCollections(),super.connectedCallback(),this.addEventListener("generate-dataset",(t=>{this.generateDatasetHandler(t)}))}render(){var t;const o=this.sourceCollectionId&&this.collectionJobIdStatesMapMap[this.sourceCollectionId];return e`
      ...
      >
        ${null===this.collections?e`<option>Loading...</option>`:e`<option value="">${j}</option>`}
    ...
    `}setCollectionIdUrlParam(t){const e=new URL(window.location.href);t?e.searchParams.set($,t.toString()):e.searchParams.delete($),history.replaceState(null,"",e.toString())}async sourceCollectionChangeHandler(t){const e=parseInt(t.target.value)||null;this.setCollectionIdUrlParam(e),await this.setSourceCollectionId(e),this.requestUpdate()}async setSourceCollectionId(t){this.sourceCollectionId=t,t&&(await this.initAvailableJobs(),this.collectionJobIdStatesMapMap[t]=await this.fetchJobIdStatesMap(t),this.maybeStartPolling())}async initCollections(){var t;const e=await A.collections.get([["limit","=",1e4],["sort","=","name"]]);this.collections=e.items,this.collectionIdNameMap=new Map(this.collections.map((t=>[t.id,t.name])));const o=parseInt(null!==(t=new URLSearchParams(window.location.search).get($))&&void 0!==t?t:"");Number.isNaN(o)||(await this.setSourceCollectionId(o),this.requestUpdate())}async initAvailableJobs(){const{sourceCollectionId:t}=this,e=await(await fetch("/api/available-jobs"+(null===t?"":`?collection_id=${t}`))).json();e.sort(((t,e)=>lt.indexOf(t.categoryName)>lt.indexOf(e.categoryName)?1:-1)).map((t=>(t.jobs.sort(((e,o)=>{const s=dt[t.categoryName];return void 0===s?0:s.indexOf(e.name)>s.indexOf(o.name)?1:-1})),t))),this.availableJobs=e}async fetchJobIdStatesMap(t){return await(await fetch(`/api/collections/${t}/dataset_states`)).json()}async pollDatasetStates(){const{sourceCollectionId:t}=this;if(null!==t&&this.activePollCollectionId===t){this.collectionJobIdStatesMapMap[t]=await this.fetchJobIdStatesMap(t),this.requestUpdate();for(const e of Object.values(this.collectionJobIdStatesMapMap[t]))if(E(e[0][2]))return void setTimeout((()=>{this.pollDatasetStates()}),1e4);this.activePollCollectionId=null}else this.activePollCollectionId=null}maybeStartPolling(){const{collectionJobIdStatesMapMap:t,sourceCollectionId:e}=this;if(null!==e&&null===this.activePollCollectionId)for(const o of Object.values(t[e]))if(E(o[0][2]))return this.activePollCollectionId=e,void this.pollDatasetStates()}get successModalContent(){return P("span",{children:["You will receive an email when your dataset is ready. You can monitor its progress on the ",P("a",{href:z.datasets,textContent:"Dataset list"})]})}async generateDatasetHandler(t){const e=t.detail.archJobCard,o=e.job.id,s=e.jobParameters,{collectionJobIdStatesMapMap:a}=this,i=this.sourceCollectionId,r=a[i],n=[0,(new Date).toISOString(),C.SUBMITTED];r[o]?r[o].unshift(n):r[o]=[n],e.jobButton.requestUpdate();try{await A.jobs.run(i,o,s)}catch{return r[o].shift(),e.jobButton.requestUpdate(),void T.showError("","Dataset generation failed. Please try again.",e.jobButton)}T.showNotification("ARCH is generating your dataset",this.successModalContent,e.jobButton),this.maybeStartPolling()}};ht.styles=nt,a([o({type:String})],ht.prototype,"csrfToken",void 0),a([n()],ht.prototype,"collections",void 0),a([n()],ht.prototype,"collectionIdNameMap",void 0),a([n()],ht.prototype,"availableJobs",void 0),a([n()],ht.prototype,"sourceCollectionId",void 0),a([n()],ht.prototype,"collectionJobIdStatesMapMap",void 0),a([n()],ht.prototype,"activePollCollectionId",void 0),a([h("select[name=source-collection]")],ht.prototype,"collectionSelector",void 0),a([f("arch-job-category-section")],ht.prototype,"categorySections",void 0),ht=a([i("arch-generate-dataset-form")],ht);export{ht as ArchGenerateDatasetForm};
