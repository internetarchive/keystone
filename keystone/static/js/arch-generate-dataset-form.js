...
`;var U=Object.defineProperty,O=Object.getOwnPropertyDescriptor,J=(t,e,o,s)=>{for(var a,i=s>1?void 0:s?O(e,o):e,r=t.length-1;r>=0;r--)(a=t[r])&&(i=(s?a(e,o,i):a(i))||i);return s&&i&&U(e,o,i),i};const q={baseSize:100,noSelectionStyle:"transform: translateX(0px) scaleX(0) scaleY(0)",transformX(t,e){return`transform: translateX(${t}px) scaleX(${e/this.baseSize});`},transformY(t,e){return`transform: translateY(${t}px) scaleY(${e/this.baseSize});`},baseStyles(){return t`
...
`;var R=Object.defineProperty,W=Object.getOwnPropertyDescriptor,Y=(t,e,o,s)=>{for(var a,i=s>1?void 0:s?W(e,o):e,r=t.length-1;r>=0;r--)(a=t[r])&&(i=(s?a(e,o,i):a(i))||i);return s&&i&&R(e,o,i),i};const G=class t extends(m(k(S(b,'[slot="icon"]'),""))){constructor(){super(...arguments),this.disabled=!1,this.label="",this.selected=!1,this.vertical=!1,this.value=""}static get styles(){return[H]}get hasIcon(){return this.slotContentIsPresent}get hasLabel(){return!!this.label||this.slotHasContent}render(){return e`
            ${this.hasIcon?e`
                      <slot name="icon"></slot>
                  `:s}
        ...
        `}firstUpdated(e){super.firstUpdated(e),this.setAttribute("role","tab"),this.hasAttribute("id")||(this.id="sp-tab-"+t.instanceCount++)}updated(t){super.updated(t),t.has("selected")&&(this.setAttribute("aria-selected",this.selected?"true":"false"),this.setAttribute("tabindex",this.selected?"0":"-1")),t.has("disabled")&&(this.disabled?this.setAttribute("aria-disabled","true"):this.removeAttribute("aria-disabled"))}};G.instanceCount=0,Y([o({type:Boolean,reflect:!0})],G.prototype,"disabled",2),Y([o({reflect:!0})],G.prototype,"label",2),Y([o({type:Boolean,reflect:!0})],G.prototype,"selected",2),Y([o({type:Boolean,reflect:!0})],G.prototype,"vertical",2),Y([o({type:String,reflect:!0})],G.prototype,"value",2),c("sp-tab",G);const X=t`
    :host{display:inline-flex}:host(:not([selected])){display:none}
`;var K=Object.defineProperty,Q=Object.getOwnPropertyDescriptor,V=(t,e,o,s)=>{for(var a,i=s>1?void 0:s?Q(e,o):e,r=t.length-1;r>=0;r--)(a=t[r])&&(i=(s?a(e,o,i):a(i))||i);return s&&i&&K(e,o,i),i};const Z=class t extends b{constructor(){super(...arguments),this.selected=!1,this.value=""}handleFocusin(){this.removeAttribute("tabindex")}handleFocusout(){this.tabIndex=this.selected?0:-1}render(){return e`
            <slot
                @focusin=${this.handleFocusin}
                @focusout=${this.handleFocusout}
            ></slot>
        `}firstUpdated(){this.slot="tab-panel",this.setAttribute("role","tabpanel"),this.tabIndex=0,this.hasAttribute("id")||(this.id="sp-tab-panel-"+t.instanceCount++)}updated(t){t.has("selected")&&(this.selected?(this.removeAttribute("aria-hidden"),this.tabIndex=0):(this.setAttribute("aria-hidden","true"),this.tabIndex=-1))}};Z.styles=[X],Z.instanceCount=0,V([o({type:Boolean,reflect:!0})],Z.prototype,"selected",2),V([o({type:String,reflect:!0})],Z.prototype,"value",2),c("sp-tab-panel",Z);var tt=[u,...g,t`
    div.input-block {
  ...
  `];let et=class extends f{};et.styles=tt,et=a([i("arch-job-parameters-form")],et);var ot=[u,p,t`
    dl {
  ...
  `];let st=class extends r{constructor(){super(...arguments),this.buttonClass="",this.buttonHTML=e``,this.jobName="",this.collectionName="",this.jobStateTuples=[]}renderButton(){const{jobStateTuples:t}=this,o=(t,o,s)=>e`
    ...
    `}};var at;st.styles=ot,st.shadowRootOptions={...r.shadowRootOptions,delegatesFocus:!0},a([o()],st.prototype,"buttonClass",void 0),a([o()],st.prototype,"buttonHTML",void 0),a([o()],st.prototype,"jobName",void 0),a([o()],st.prototype,"collectionName",void 0),a([o()],st.prototype,"jobParameters",void 0),a([o()],st.prototype,"jobStateTuples",void 0),st=a([i("arch-job-button")],st);let it=at=class extends r{constructor(){super(...arguments),this.jobParameters={}}extendParamsSchemaWithDefaultOptions(t){return t=null!=t?t:at.DefaultParametersSchema,Object.assign(t,{properties:Object.assign(t.properties,{sample:{type:"boolean",title:"Sample",default:!1,description:"Generate a sample dataset from a small subset of records"}})})}get historicalDatasetsUrl(){const{collectionId:t,job:e}=this;return`${j.collection(t)}?column-name=${encodeURIComponent(e.name)}`}renderHistory(){const{jobIdStatesMap:t,job:o}=this,s=t&&t[o.id];if(void 0===s||0===s.length)return e`
        <h4>History</h4>
        <p class="history">
    ...
    `}emitGenerateDataset(t){t.stopPropagation(),this.dispatchEvent(new CustomEvent("generate-dataset",{detail:{archJobCard:this},bubbles:!0,composed:!0}))}render(){var t;const{collectionId:o,collectionName:s,job:a,jobIdStatesMap:i,jobParameters:r}=this,{id:n}=a,c=this.jobIdStatesMap?null!==(t=i[n])&&void 0!==t?t:null:void 0;return e` <div>
      ...
      ${null===o?e`<p class="alert alert-info">
          ...
          `}
    </div>`}};it.styles=ot,it.DefaultParametersSchema={type:"object",required:[],properties:{}},a([o({type:Number})],it.prototype,"collectionId",void 0),a([o({type:String})],it.prototype,"collectionName",void 0),a([o()],it.prototype,"job",void 0),a([o()],it.prototype,"jobIdStatesMap",void 0),a([n()],it.prototype,"jobParameters",void 0),a([h("arch-job-button")],it.prototype,"jobButton",void 0),it=at=a([i("arch-job-card")],it);var rt=[u,t`
    label {
  ...
  `];let nt=class extends r{render(){const{collectionId:t,collectionName:o,jobIdStatesMap:s}=this,{categoryDescription:a,jobs:i}=this.jobsCat;return e`
    ...
    `}};nt.styles=rt,a([o({type:String})],nt.prototype,"collectionId",void 0),a([o({type:String})],nt.prototype,"collectionName",void 0),a([o({type:Object})],nt.prototype,"jobsCat",void 0),a([o({type:Object})],nt.prototype,"jobIdStatesMap",void 0),nt=a([i("arch-job-category-section")],nt);const ct=["Collection","Network","Text","File Formats"],lt={Collection:["Domain frequency","Web archive transformation (WAT)"],Network:["Domain graph","Image graph","Longitudinal graph","Web graph"],Text:["Named entities","Plain text of webpages","Text file information"],"File Formats":["Audio file information","Image file information","PDF file information","Presentation file information","Spreadsheet file information","Video file information","Word processing file information"]};let dt=class extends r{constructor(){super(...arguments),this.collections=null,this.collectionIdNameMap=new Map,this.availableJobs=[],this.sourceCollectionId=null,this.collectionJobIdStatesMapMap={},this.activePollCollectionId=null}async connectedCallback(){await this.initAvailableJobs(),this.initCollections(),super.connectedCallback(),this.addEventListener("generate-dataset",(t=>{this.generateDatasetHandler(t)}))}render(){var t;const o=this.sourceCollectionId&&this.collectionJobIdStatesMapMap[this.sourceCollectionId];return e`
