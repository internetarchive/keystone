...
`;var _=Object.defineProperty,O=Object.getOwnPropertyDescriptor,q=(t,e,o,s)=>{for(var a,i=s>1?void 0:s?O(e,o):e,r=t.length-1;r>=0;r--)(a=t[r])&&(i=(s?a(e,o,i):a(i))||i);return s&&i&&_(e,o,i),i};const B={baseSize:100,noSelectionStyle:"transform: translateX(0px) scaleX(0) scaleY(0)",transformX(t,e){return`transform: translateX(${t}px) scaleX(${e/this.baseSize});`},transformY(t,e){return`transform: translateY(${t}px) scaleY(${e/this.baseSize});`},baseStyles(){return t`
...
`;var R=Object.defineProperty,W=Object.getOwnPropertyDescriptor,Y=(t,e,o,s)=>{for(var a,i=s>1?void 0:s?W(e,o):e,r=t.length-1;r>=0;r--)(a=t[r])&&(i=(s?a(e,o,i):a(i))||i);return s&&i&&R(e,o,i),i};const G=class t extends(m(k(S(b,'[slot="icon"]'),""))){constructor(){super(...arguments),this.disabled=!1,this.label="",this.selected=!1,this.vertical=!1,this.value=""}static get styles(){return[H]}get hasIcon(){return this.slotContentIsPresent}get hasLabel(){return!!this.label||this.slotHasContent}render(){return e`
        ...
        `}firstUpdated(e){super.firstUpdated(e),this.setAttribute("role","tab"),this.hasAttribute("id")||(this.id="sp-tab-"+t.instanceCount++)}updated(t){super.updated(t),t.has("selected")&&(this.setAttribute("aria-selected",this.selected?"true":"false"),this.setAttribute("tabindex",this.selected?"0":"-1")),t.has("disabled")&&(this.disabled?this.setAttribute("aria-disabled","true"):this.removeAttribute("aria-disabled"))}};G.instanceCount=0,Y([o({type:Boolean,reflect:!0})],G.prototype,"disabled",2),Y([o({reflect:!0})],G.prototype,"label",2),Y([o({type:Boolean,reflect:!0})],G.prototype,"selected",2),Y([o({type:Boolean,reflect:!0})],G.prototype,"vertical",2),Y([o({type:String,reflect:!0})],G.prototype,"value",2),c("sp-tab",G);const K=t`
    :host{display:inline-flex}:host(:not([selected])){display:none}
`;var X=Object.defineProperty,Q=Object.getOwnPropertyDescriptor,V=(t,e,o,s)=>{for(var a,i=s>1?void 0:s?Q(e,o):e,r=t.length-1;r>=0;r--)(a=t[r])&&(i=(s?a(e,o,i):a(i))||i);return s&&i&&X(e,o,i),i};const Z=class t extends b{constructor(){super(...arguments),this.selected=!1,this.value=""}handleFocusin(){this.removeAttribute("tabindex")}handleFocusout(){this.tabIndex=this.selected?0:-1}render(){return e`
            <slot
                @focusin=${this.handleFocusin}
                @focusout=${this.handleFocusout}
            ></slot>
        `}firstUpdated(){this.slot="tab-panel",this.setAttribute("role","tabpanel"),this.tabIndex=0,this.hasAttribute("id")||(this.id="sp-tab-panel-"+t.instanceCount++)}updated(t){t.has("selected")&&(this.selected?(this.removeAttribute("aria-hidden"),this.tabIndex=0):(this.setAttribute("aria-hidden","true"),this.tabIndex=-1))}};Z.styles=[K],Z.instanceCount=0,V([o({type:Boolean,reflect:!0})],Z.prototype,"selected",2),V([o({type:String,reflect:!0})],Z.prototype,"value",2),c("sp-tab-panel",Z);var tt=[u,...g,t`
    div.input-block {
