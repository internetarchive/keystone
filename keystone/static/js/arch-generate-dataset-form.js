...
`;var O=Object.defineProperty,J=Object.getOwnPropertyDescriptor,q=(t,e,o,s)=>{for(var i,a=s>1?void 0:s?J(e,o):e,r=t.length-1;r>=0;r--)(i=t[r])&&(a=(s?i(e,o,a):i(a))||a);return s&&a&&O(e,o,a),a};const B={baseSize:100,noSelectionStyle:"transform: translateX(0px) scaleX(0) scaleY(0)",transformX(t,e){return`transform: translateX(${t}px) scaleX(${e/this.baseSize});`},transformY(t,e){return`transform: translateY(${t}px) scaleY(${e/this.baseSize});`},baseStyles(){return t`
...
`;var W=Object.defineProperty,G=Object.getOwnPropertyDescriptor,Y=(t,e,o,s)=>{for(var i,a=s>1?void 0:s?G(e,o):e,r=t.length-1;r>=0;r--)(i=t[r])&&(a=(s?i(e,o,a):i(a))||a);return s&&a&&W(e,o,a),a};const X=class t extends(m(C(z(u,'[slot="icon"]'),""))){constructor(){super(...arguments),this.disabled=!1,this.label="",this.selected=!1,this.vertical=!1,this.value=""}static get styles(){return[R]}get hasIcon(){return this.slotContentIsPresent}get hasLabel(){return!!this.label||this.slotHasContent}render(){return e`
            ${this.hasIcon?e`
                      <slot name="icon"></slot>
                  `:s}
        ...
        `}firstUpdated(e){super.firstUpdated(e),this.setAttribute("role","tab"),this.hasAttribute("id")||(this.id="sp-tab-"+t.instanceCount++)}updated(t){super.updated(t),t.has("selected")&&(this.setAttribute("aria-selected",this.selected?"true":"false"),this.setAttribute("tabindex",this.selected?"0":"-1")),t.has("disabled")&&(this.disabled?this.setAttribute("aria-disabled","true"):this.removeAttribute("aria-disabled"))}};X.instanceCount=0,Y([o({type:Boolean,reflect:!0})],X.prototype,"disabled",2),Y([o({reflect:!0})],X.prototype,"label",2),Y([o({type:Boolean,reflect:!0})],X.prototype,"selected",2),Y([o({type:Boolean,reflect:!0})],X.prototype,"vertical",2),Y([o({type:String,reflect:!0})],X.prototype,"value",2),c("sp-tab",X);const K=t`
    :host{display:inline-flex}:host(:not([selected])){display:none}
`;var Q=Object.defineProperty,V=Object.getOwnPropertyDescriptor,Z=(t,e,o,s)=>{for(var i,a=s>1?void 0:s?V(e,o):e,r=t.length-1;r>=0;r--)(i=t[r])&&(a=(s?i(e,o,a):i(a))||a);return s&&a&&Q(e,o,a),a};const tt=class t extends u{constructor(){super(...arguments),this.selected=!1,this.value=""}handleFocusin(){this.removeAttribute("tabindex")}handleFocusout(){this.tabIndex=this.selected?0:-1}render(){return e`
            <slot
                @focusin=${this.handleFocusin}
                @focusout=${this.handleFocusout}
            ></slot>
        `}firstUpdated(){this.slot="tab-panel",this.setAttribute("role","tabpanel"),this.tabIndex=0,this.hasAttribute("id")||(this.id="sp-tab-panel-"+t.instanceCount++)}updated(t){t.has("selected")&&(this.selected?(this.removeAttribute("aria-hidden"),this.tabIndex=0):(this.setAttribute("aria-hidden","true"),this.tabIndex=-1))}};tt.styles=[K],tt.instanceCount=0,Z([o({type:Boolean,reflect:!0})],tt.prototype,"selected",2),Z([o({type:String,reflect:!0})],tt.prototype,"value",2),c("sp-tab-panel",tt);var et=[b,...y,t`
    div.input-block {
  ...
  `];let ot=class extends x{};ot.styles=et,ot=i([a("arch-job-parameters-form")],ot);var st=[b,g,t`
    div > h3 {
      margin-top: 0;
    }
  ...
  `];let it=class extends r{constructor(){super(...arguments),this.buttonClass="",this.buttonHTML=e``,this.jobName="",this.collectionName="",this.jobStateTuples=[]}renderButton(){const{jobStateTuples:t}=this,o=(t,o,s)=>e`
      <button slot="trigger" class=${o} ?disabled=${s}>
        ${f(t)}
      </button>
    `;switch(t){case void 0:return o("Loading...","",!0);case null:return o("Generate Dataset","primary",!1)}switch(t[0][2]){case T.SUBMITTED:return o('<arch-loading-indicator text="Job Starting"></arch-loading-indicator>',"",!0);case T.QUEUED:return o("Job Queued","",!0);case T.RUNNING:return o('<arch-loading-indicator text="Job Running"></arch-loading-indicator>',"",!0);case T.FINISHED:case T.FAILED:case T.CANCELLED:return o("Generate New Dataset","primary",!1)}}render(){const{jobName:t,collectionName:o}=this;return e`
      <arch-modal title="Generate Dataset">
        <p slot="content">
          You're about to generate a <strong>${t}</strong> dataset from
          the <strong>${o}</strong> collection.
        </p>
        ${this.renderButton()}
      </arch-modal>
    `}};var at;it.styles=st,it.shadowRootOptions={...r.shadowRootOptions,delegatesFocus:!0},i([o()],it.prototype,"buttonClass",void 0),i([o()],it.prototype,"buttonHTML",void 0),i([o()],it.prototype,"jobName",void 0),i([o()],it.prototype,"collectionName",void 0),i([o()],it.prototype,"jobStateTuples",void 0),it=i([a("arch-job-button")],it);let rt=at=class extends r{constructor(){super(...arguments),this.jobParameters={}}extendParamsSchemaWithDefaultOptions(t){return t=null!=t?t:at.DefaultParametersSchema,Object.assign(t,{properties:Object.assign(t.properties,{sample:{type:"boolean",title:"Sample",default:!0,description:"Generate a sample dataset from a small subset of records"}})})}get historicalDatasetsUrl(){const{collectionId:t,job:e}=this;return`${E.collection(t)}?column-name=${encodeURIComponent(e.name)}`}renderHistory(){const{jobIdStatesMap:t,job:o}=this,s=t&&t[o.id];if(void 0===s||0===s.length)return e`
        <h4>History</h4>
        <p class="history">
          No datasets of this type have been generated for this collection.
        </p>
      `;const i=s.filter((([,,t])=>t===T.FINISHED));if(0===i.length)return e`
        <h4>History</h4>
        <p class="history">
          No datasets of this type have been completed for this collection.
        </p>
      `;const a=i.length>1;return e`
      <h4>History</h4>
      <p class="history">
        You've generated this dataset
        <a href="${this.historicalDatasetsUrl}" target="_blank">
          <strong
            >${i.length}&nbsp;time${a?"s":""}</strong
          >
        </a>
        for this collection, most recently on
        <a href="${E.dataset(i[0][0])}">
          <strong>${P(i[0][1])}</strong> </a
        >.
      </p>
    `}renderConfigureJob(){const{job:t}=this;return e`
      <h4>Configure Job</h4>
      <arch-job-parameters-form
        .schema=${this.extendParamsSchemaWithDefaultOptions(t.parameters_schema)}
        .data=${this.jobParameters}
      ></arch-job-parameters-form>
    `}emitGenerateDataset(t){t.stopPropagation(),this.dispatchEvent(new CustomEvent("generate-dataset",{detail:{archJobCard:this},bubbles:!0,composed:!0}))}render(){var t;const{collectionId:o,collectionName:s,job:i,jobIdStatesMap:a}=this,{id:r}=i,n=this.jobIdStatesMap?null!==(t=a[r])&&void 0!==t?t:null:void 0;return e` <div>
      <h3>${i.name}</h3>
      <p>${i.description}</p>
      ${null===o?e`<p class="alert alert-info">
          ...
          `}
    </div>`}};rt.styles=st,rt.DefaultParametersSchema={type:"object",required:[],properties:{}},i([o({type:Number})],rt.prototype,"collectionId",void 0),i([o({type:String})],rt.prototype,"collectionName",void 0),i([o()],rt.prototype,"job",void 0),i([o()],rt.prototype,"jobIdStatesMap",void 0),i([n()],rt.prototype,"jobParameters",void 0),i([h("arch-job-button")],rt.prototype,"jobButton",void 0),rt=at=i([a("arch-job-card")],rt);var nt=[b,t`
    label {
      background-color: ${p};
      color: ${v};
      padding: 0.5rem;
  ...
  `];let ct=class extends r{render(){const{collectionId:t,collectionName:o,jobIdStatesMap:s}=this,{categoryDescription:i,categoryId:a,categoryImage:r,categoryName:n,jobs:c}=this.jobsCat;return e`
      <div class="category-header">
        <img
          ...
          alt="Icon for ${n}"
        />
        <h2 id="${a}" class="category-title">${n}</h2>
        <p class="category-description">${i}</p>
      </div>
    ...
    `}};ct.styles=nt,i([o({type:String})],ct.prototype,"collectionId",void 0),i([o({type:String})],ct.prototype,"collectionName",void 0),i([o({type:Object})],ct.prototype,"jobsCat",void 0),i([o({type:Object})],ct.prototype,"jobIdStatesMap",void 0),ct=i([a("arch-job-category-section")],ct);const lt=["Collection","Network","Text","File Formats"],dt={Collection:["Domain frequency","Web archive transformation (WAT)"],Network:["Domain graph","Image graph","Longitudinal graph","Web graph"],Text:["Named entities","Plain text of webpages","Text file information"],"File Formats":["Audio file information","Image file information","PDF file information","Presentation file information","Spreadsheet file information","Video file information","Word processing file information"]};let ht=class extends r{constructor(){super(...arguments),this.collections=null,this.collectionIdNameMap=new Map,this.availableJobs=[],this.sourceCollectionId=null,this.collectionJobIdStatesMapMap={},this.activePollCollectionId=null}async connectedCallback(){await this.initAvailableJobs(),this.initCollections(),super.connectedCallback(),this.addEventListener("generate-dataset",(t=>{this.generateDatasetHandler(t)}))}render(){var t;const o=this.sourceCollectionId&&this.collectionJobIdStatesMapMap[this.sourceCollectionId];return e`
      ...
      >
        ${null===this.collections?e`<option>Loading...</option>`:e`<option value="">~ Choose Source Collection ~</option>`}
